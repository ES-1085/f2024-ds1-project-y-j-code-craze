...
Internship_Leaflet_Cleaned_Complete <- read_csv("/cloud/project/data/Internship_Leaflet_Official - Complete.csv")
```
...
We wanted to compare each catagory of internship by decade.
```{r}
