...
<<<<<<< HEAD
read.csv("/cloud/project/data/Tidy_Mapped_Clean")
=======
Tidy_Mapped_Clean <- read.csv("/cloud/project/data/Tidy_Mapped_Clean.csv")
Internship_Leaflet_Cleaned_Complete <- read_csv("data/Internship_Leaflet_Cleaned - Complete.csv")
>>>>>>> b947a7659dd0628f33f92ed7611109dc5b94dd53
```
...
local_cities <- c("Bar Harbor", "Northea", "Chicago")
```
